<template>
  <div class="max-w-3xl">
    <h1 class="mb-6 text-2xl font-semibold tracking-tight text-slate-900">Edit News</h1>
    <form @submit.prevent="save" class="space-y-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      ...
      <button type="submit" class="w-full rounded bg-green-600 py-2 text-sm font-medium text-white transition hover:bg-green-700">Update</button>
    </form>
  </div>
</template>
